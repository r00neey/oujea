...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        // Nastavení zprávy do session pro notifikaci
        $_SESSION['success_message'] = "Uživatel byl úspěšně přidán.";
        header("Location: users.php"); // Přejít na stránku se seznamem uživatelů
        exit;
    } else {
