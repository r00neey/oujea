    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3 pb-3">
                ...
                <section class="mt-5">
                    <h2>Posledních deset přihlášených lidí</h2>
                    <?php
                    // create sql query that lists last 10 users and writes them as a table their attributes are id, jmeno, prijmeni, email, telefon, pracovna, popisek
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row["pracovna"] . "</td>";
                            echo "<td>" . $row["popisek"] . "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
                        echo "</table>";
